...
<div class="col-lg-8">
    ...
    <div class="card mb-4" style="border-radius:12px; border:1px solid #e0e4ec;">
        <div class="card-body">
            <div class="d-flex align-items-center justify-content-between flex-wrap">
                ...
                <a href="{{ route('counselee.appointments.index') }}" class="btn btn-light btn-sm" style="border-radius:20px; border:1px solid #e0e4ec;">
    ...
    .date-btn:hover { border-color:#D30404; color:#D30404; }
    ...
    <form id="rescheduleForm" action="{{ route('counselee.appointments.reschedule', $appointment) }}" method="POST">
        @csrf
        ...
        <div class="section-card">
            <div class="section-header"><i class="fas fa-calendar-alt mr-2" style="color:#D30404;"></i>Step 1 — Pick a New Date</div>
        ...
        <div id="step2" class="section-card" style="display:none;">
            <div class="section-header"><i class="fas fa-clock mr-2" style="color:#D30404;"></i>Step 2 — Pick a New Time</div>
            <div class="section-body">
        ...
        <div id="step3" class="section-card" style="display:none;">
            <div class="section-header"><i class="fas fa-comment-alt mr-2" style="color:#D30404;"></i>Reason <span class="text-muted" style="font-weight:400;">(optional)</span></div>
            <div class="section-body">
...
const ROUTES = {
    ...
    slots: '{{ route("counselee.appointments.reschedule.slots", $appointment) }}',
    csrf:  '{{ csrf_token() }}',
    counselTypeId: {{ $appointment->counsel_type_id }},
};
...
function loadDates() {
    ...
    fetch(ROUTES.dates, {
        ...
        body: JSON.stringify({ counsel_type_id: ROUTES.counselTypeId }),
    })
    .then(r => r.json())
    .then(data => {
