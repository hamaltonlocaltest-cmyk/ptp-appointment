...
<div class="col-lg-8">
    ...
    <div class="card mb-4" style="border-radius:12px; border:1px solid #e0e4ec;">
        <div class="card-body">
            <div class="d-flex align-items-center justify-content-between flex-wrap">
                ...
                <a href="{{ route('counselor.appointments.index') }}" class="btn btn-light btn-sm" style="border-radius:20px; border:1px solid #e0e4ec;">
    ...
    .date-btn:hover { border-color:#1b5e20; color:#1b5e20; }
    .date-btn.selected { border-color:#1b5e20; background:#1b5e20; color:#fff; }
    ...
    .slot-btn:hover { border-color:#2e7d32; color:#2e7d32; }
    .slot-btn.selected { border-color:#2e7d32; background:#2e7d32; color:#fff; }
    ...
    .section-card .section-header {
        ...
        border-radius:12px 12px 0 0; font-weight:700; color:#1b5e20; font-size:14px;
    }
    ...
    <form id="rescheduleForm" action="{{ route('counselor.appointments.reschedule', $appointment) }}" method="POST">
        @csrf
        ...
        <div id="step2" class="section-card" style="display:none;">
            ...
            <div class="section-body">
                ...
                <div id="counselorInfo" class="mt-3" style="display:none;">
                    <div style="display:inline-flex; align-items:center; gap:8px; background:#e8f5e9; border:1px solid #a5d6a7; color:#1b5e20; border-radius:8px; padding:10px 16px; font-size:13px; font-weight:600;">
        ...
        <div id="step3" class="section-card" style="display:none;">
            ...
            <div class="section-body">
                ...
                <div class="mt-4 d-flex justify-content-end">
                    <button type="submit" class="btn" style="background:#1b5e20; color:#fff; border-radius:7px; padding:10px 30px; font-weight:700; font-size:15px;">
...
<script>
const ROUTES = {
    dates: '{{ route("counselor.appointments.reschedule.dates", $appointment) }}',
    slots: '{{ route("counselor.appointments.reschedule.slots", $appointment) }}',
    csrf:  '{{ csrf_token() }}',
};
