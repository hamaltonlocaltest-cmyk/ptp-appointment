...
.wrap { max-width:600px; margin:30px auto; background:#fff; border-radius:14px; overflow:hidden; box-shadow:0 6px 28px rgba(211,4,4,0.12); }
.hdr { background:linear-gradient(135deg, #D30404, #b71c1c); padding:32px 30px 28px; text-align:center; }
...
.hdr p  { color:#ffcccc; margin:6px 0 0; font-size:13px; }
.body { padding:30px 30px 26px; color:#333; line-height:1.6; }
.body h2 { color:#D30404; margin:0 0 6px; font-size:17px; font-weight:700; }
...
.btn { display:inline-block; background:linear-gradient(135deg, #D30404, #b71c1c); color:#fff !important; text-decoration:none; padding:13px 32px; border-radius:10px; font-size:14.5px; font-weight:700; box-shadow:0 6px 16px rgba(211,4,4,0.25); }
