...
@section('title', 'Counselor Utilization Report')
@section('page-title', 'Counselor Utilization Report')
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('admin.reports.index') }}">Reports</a></li>
    <li class="breadcrumb-item active">Counselor Utilization</li>
@endsection
...
<div class="card mb-3">
    <div class="card-header" style="background:#fff;">
        <span style="font-weight:600;"><i class="fas fa-filter mr-2" style="color:#2e7d32;"></i> Filters</span>
    </div>
    <div class="card-body">
        <p class="text-muted mb-3" style="font-size:12.5px;">Defaults to the last 30 days if no date range is set.</p>
        <div class="row">
            ...
            <div class="col-md-3 mb-2">
                <label class="form-label" style="font-size:12px; font-weight:600; color:#555;">City</label>
...
<div class="card">
    <div class="card-header" style="background:#fff;">
        <span style="font-weight:600;"><i class="fas fa-business-time mr-2"></i> Counselor Utilization</span>
    </div>
    <div class="card-body">
...
document.addEventListener('DOMContentLoaded', function () {
    initReportTable({
        ...
        ajaxUrl: '{{ route('admin.reports.counselor-utilization.data') }}',
        exportUrl: '{{ route('admin.reports.counselor-utilization.export') }}',
        filterIds: ['date_from', 'date_to', 'counselor_id', 'city_id'],
        columns: [
            { data: 'counselor' },
