    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header" style="background:#fff;">
                <span style="font-weight:600;"><i class="fas fa-plus-circle mr-2" style="color:#1a237e;"></i> New State</span>
            </div>
            <div class="card-body p-4">
                ...
                <form action="{{ route('admin.masters.states.store') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary"><i class="fas fa-save mr-1"></i> Save State</button>
                    </div>
                </form>
            </div>
        </div>
